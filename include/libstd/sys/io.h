...
/**
 * @brief Open formatted system call.
 *
...
/**
 * @brief Open formatted with va_list system call.
 *
 ...
 * `open2` is called on `sys:/pipe/new` then fd[0] will store the read end of the pipe and fd[1] will store the write
...
/**
 * @brief Write formatted system call.
 *
...
/**
 * @brief Allocdir readdir wrapper.
 *
