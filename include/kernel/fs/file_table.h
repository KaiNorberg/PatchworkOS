 ...
 * @return On success, a new reference to the file. On failure, `NULL`.
 */
 ...
 * @return On success, the allocated file descriptor. On failure, `FD_NONE`.
 */
 ...
 * @return `true` if the file descriptor was set, `false` otherwise.
 */
