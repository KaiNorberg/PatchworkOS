...
static uintmax_t _strtox_main(const char** p, unsigned int base, uintmax_t error, uintmax_t limval, int limdigit,
    char* sign)
{
    uintmax_t rc = 0;
    int digit = -1;
...
unsigned long int strtoul(const char* s, char** endptr, int base)
{
    ...
    rc = (unsigned long int)_strtox_main(&p, (unsigned)base, (uintmax_t)ULONG_MAX, (uintmax_t)(ULONG_MAX / base),
