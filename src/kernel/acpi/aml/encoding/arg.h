 ...
 * - Arg6Op := 0x6E.
 *
 * @param state Pointer to the AML state containing the argument objects.
 * @param out Pointer to the node where the argument object will be stored.
