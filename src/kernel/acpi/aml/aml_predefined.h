 ...
 */
uint64_t aml_osi_implementation(aml_method_t* method, uint64_t argCount, aml_object_t** args,
 ...
 * @return On success, 0. On failure, `ERR` and `errno` is set.
 */
uint64_t aml_rev_implementation(aml_method_t* method, uint64_t argCount, aml_object_t** args,
    aml_object_t* returnValue);
