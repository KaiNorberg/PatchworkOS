    ...
    .map =
        {
            ...
            [KEY_ENTER] = {.norm = '\n', .shift = '\n'},
            [KEY_ESC] = {.norm = 0x1B, .shift = 0x1B},
            [KEY_BACKSPACE] = {.norm = 0x08, .shift = 0x08},
            [KEY_TAB] = {.norm = '\t', .shift = '\t'},
            ...
            [KEY_KP_0] = {.norm = '0', .shift = KEY_NONE},
            [KEY_KP_1] = {.norm = '1', .shift = KEY_NONE},
            [KEY_KP_2] = {.norm = '2', .shift = KEY_NONE},
            [KEY_KP_3] = {.norm = '3', .shift = KEY_NONE},
            [KEY_KP_4] = {.norm = '4', .shift = KEY_NONE},
            [KEY_KP_5] = {.norm = '5', .shift = KEY_NONE},
            [KEY_KP_6] = {.norm = '6', .shift = KEY_NONE},
            [KEY_KP_7] = {.norm = '7', .shift = KEY_NONE},
            [KEY_KP_8] = {.norm = '8', .shift = KEY_NONE},
            [KEY_KP_9] = {.norm = '9', .shift = KEY_NONE},
            [KEY_KP_PERIOD] = {.norm = '.', .shift = KEY_NONE},
            [KEY_KP_SLASH] = {.norm = '/', .shift = KEY_NONE},
            [KEY_KP_ASTERISK] = {.norm = '*', .shift = KEY_NONE},
            [KEY_KP_MINUS] = {.norm = '-', .shift = KEY_NONE},
            [KEY_KP_PLUS] = {.norm = '+', .shift = KEY_NONE},
            [KEY_KP_ENTER] = {.norm = '\n', .shift = '\n'},
