 ...
 * @defgroup comp_libgfx_vertices Vertices
 * @ingroup comp_libgfx
 *
 * @{
 */
 ...
 */
#define GFX_VERTS_GET_X(_vertices, _index) ((_vertices)[((_index) * 2) + 0])
 ...
 * @param _index The index of the point.
 */
#define GFX_VERTS_GET_Y(_vertices, _index) ((_vertices)[((_index) * 2) + 1])
 ...
 */
#define GFX_VERTS_SET_X(_vertices, _index, _x) ((_vertices)[((_index) * 2) + 0] = (_x))
 ...
 */
#define GFX_VERTS_SET_Y(_vertices, _index, _y) ((_vertices)[((_index) * 2) + 1] = (_y))
 ...
 * @param vertices An array of x, y coordinate pairs.
 * @param count The number of vertices in the polygon.
 * @param bounds A pointer to a gfx_rect_t to store the bounding box in.
 */
