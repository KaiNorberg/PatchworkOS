 ...
 * and that, since it is blindly concatenating contents, multiple files of the same name can appear in the same
 * directory. The gain is that it provides far more predictable behavior than traditional union file systems.
 *
 * ## Payload
 *
