 ...
 * @defgroup libc_comp Component Management
 * @ingroup libc
 *
 ...
 *
 * @see libc_scon for more information.
 *
 * ### Expressions
 *
 ...
 * @param error Optional buffer for storing a verbose error string.
 * @param errorLength The length of the error buffer.
 * @return An appropriate status value.
 */
status_t comp_launch(const char* name, const char* version, const comp_options_t* opts, char* error,
    size_t errorLength);
